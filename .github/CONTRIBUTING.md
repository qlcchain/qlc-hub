...
```bash
git clone https://github.com/qlcchain/qlc-hub
cd qlc-hub
make build
```
...
We prefer the standard GitHub workflow. You create a fork of the go-qlc repository, make branches for features/issues, and commit and push to the master branch. 
