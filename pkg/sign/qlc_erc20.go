...
func (_QLCChain *QLCChainTransactor) Burn(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _QLCChain.contract.Transact(opts, "burn", amount)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 amount) returns()
func (_QLCChain *QLCChainSession) Burn(amount *big.Int) (*types.Transaction, error) {
	return _QLCChain.Contract.Burn(&_QLCChain.TransactOpts, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 amount) returns()
func (_QLCChain *QLCChainTransactorSession) Burn(amount *big.Int) (*types.Transaction, error) {
	return _QLCChain.Contract.Burn(&_QLCChain.TransactOpts, amount)
}
...
//
// Solidity: function mint(uint256 amount, bytes32 nHash, bytes signature) returns()
func (_QLCChain *QLCChainTransactor) Mint(opts *bind.TransactOpts, amount *big.Int, nHash [32]byte, signature []byte) (*types.Transaction, error) {
	return _QLCChain.contract.Transact(opts, "mint", amount, nHash, signature)
}

// Mint is a paid mutator transaction binding the contract method 0x9ab475b5.
//
// Solidity: function mint(uint256 amount, bytes32 nHash, bytes signature) returns()
func (_QLCChain *QLCChainSession) Mint(amount *big.Int, nHash [32]byte, signature []byte) (*types.Transaction, error) {
	return _QLCChain.Contract.Mint(&_QLCChain.TransactOpts, amount, nHash, signature)
}

// Mint is a paid mutator transaction binding the contract method 0x9ab475b5.
//
// Solidity: function mint(uint256 amount, bytes32 nHash, bytes signature) returns()
func (_QLCChain *QLCChainTransactorSession) Mint(amount *big.Int, nHash [32]byte, signature []byte) (*types.Transaction, error) {
	return _QLCChain.Contract.Mint(&_QLCChain.TransactOpts, amount, nHash, signature)
}
...
//
// Solidity: event Mint(address indexed user, uint256 amount)
